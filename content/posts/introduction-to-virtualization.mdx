---
  title: Red Hat OpenShift Virtualization Engine
  summary: Red Hat® OpenShift® Virtualization Engine provides the proven virtualization functionality of Red Hat OpenShift to deploy, manage, and scale virtual machines (VMs).
  image: /images/posts/virtual.webp
  author: 'Haron Ngaira'
