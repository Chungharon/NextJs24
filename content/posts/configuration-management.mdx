---
  title: Red Hat Configuration Managment with Ansible
  summary: Virtual infrastructure management with Red Hat Ansible Automation Platform.
  image: /images/posts/ansible.webp
  author: 'Haron Ngaira'
